...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-116360025-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-116360025-1');
</script>
...
<head>
 ...
 <link rel="shortcut icon" href="ch_favicon.ico" type="image/x-icon">
        </head>
